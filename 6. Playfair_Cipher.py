...
def isCharInMatrix(matrix, char):
    x, y = indexOfInMatrix(matrix, char)
    return x != -1 and y != -1


def indexOfInMatrix(matrix, char):
...
def encrypt(plaintext: str, keyMatrix) -> str:
    cipher = ""
...
def decrypt(cipher: str, keyMatrix) -> str:
    plaintext = ""
